            ...
            <div className="app__specialMenu flex__center section__padding">
                ...
                <div className="app__specialMenu-menu">
                    <div className="app__specialMenu-menu_pasta flex__center" style={{padding: '0 2rem 0 2rem'}}>
                        ...
                        <button type="button" className="custom__button" style={{margin: '1rem 0 1rem 0'}} onClick={() => handleCategory('Makarony i ryż z WOK')}>
                    ...
                    <div className="app__specialMenu-menu_seafood flex__center" style={{padding: '0 2rem 0 2rem'}}>
                        ...
                        <button type="button" className="custom__button" style={{margin: '1rem 0 1rem 0'}} onClick={() => handleCategory('Owoce morza')}>
                            <Link to="/addDishToMenu">Dodaj danie do tej kategorii</Link>
                        </button>
                        <div className="app__specialMenu_menu_items">
                            {dishes
                ...
                <div className="app__specialMenu-menu">
                    <div className="app__specialMenu-menu_pasta flex__center" style={{padding: '0 2rem 0 2rem'}}>
                        ...
                        <button type="button" className="custom__button" style={{margin: '1rem 0 1rem 0'}} onClick={() => handleCategory('Zupy')}>
                            <Link to="/addDishToMenu">Dodaj danie do tej kategorii</Link>
                        </button>
                        <div className="app__specialMenu_menu_items">
                            {dishes
                    ...
                    <div className="app__specialMenu-menu_seafood flex__center" style={{padding: '0 2rem 0 2rem'}}>
                        ...
                        <button type="button" className="custom__button" style={{margin: '1rem 0 1rem 0'}} onClick={() => handleCategory('Desery')}>
                            <Link to="/addDishToMenu">Dodaj danie do tej kategorii</Link>
                        </button>
                        <div className="app__specialMenu_menu_items">
                            {dishes
