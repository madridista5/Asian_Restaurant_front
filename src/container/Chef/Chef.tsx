  ...
  <div className="app__bg app__wrapper section__padding">
      ...
      <div className="app__wrapper_info">
          ...
          <div className="app__chef-content">
              ...
              <p className="p__opensans">Świadomość tego że jesteśmy tym co jemy, sprawia że najważniejsze dla nas jest gotowanie zdrowych, i lekkostrawnych dań serwowanych w przyjemnej atmosferze. Nad procesem powstawania i serwowania dań pieczę sprawuje  profesjonalna załoga restauracji Asian Food.</p>
